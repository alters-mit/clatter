...
namespace Clatter.Core
{
    ...
    /// </summary>
    internal static class LinSpace
    {
        /// <summary>
        ...
        internal static double[] Get(double a, double b, int steps)
        {
        ...
        internal static void GetInPlace(double a, double b, int steps, ref double[] arr)
        {
            if (arr.Length < steps)
            {
