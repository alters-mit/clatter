...
namespace Clatter.Core
{
    ...
    public class AudioGenerator
    {
        ...
        /// <summary>
        /// This method is optional. Load pre-recorded impulse response data from files. If you call this method, audio generated by the two objects will always use one of the impulse responses provided. If you don't call this method, the two objects will always use impulses that are generated at runtime. If there are already impulse response for this object IDs pair, this method fails silently.  
        /// </summary>
        ...
        public void LoadImpulseResponse(uint primaryID, uint secondaryID, string[] paths)
        {
            ...
            {
                double[][] irs = new double[paths.Length][];
                // Load each impulse response.
                for (int i = 0; i < paths.Length; i++)
                {
                    irs[i] = Loader.LoadImpulseResponse(paths[i]);
                }
                impulseResponses.Add(ids, irs);
            }
        }
