...
namespace Clatter.Unity
{
    ...
    public class ClatterObject : MonoBehaviour
    {
        ...
        /// <summary>
        /// The minimum collision speed in meters per second. If the collision is slower than this, it is ignored.
        /// </summary>
        ...
        /// </summary>
        public static AudioEventType rollSubstitute = AudioEventType.impact;
        /// <summary>
        ...
        /// <summary>
        /// The resonance value (0 to 1). This affects the decay times of audio generated by this object.
        /// </summary>
        [Range(0, 1)]
        ...
        /// <summary>
        /// If physicMaterialMode == PhysicMaterialMode.manual, this is the physic material dynamic friction value (0 to 1). To derive friction values from `Clatter.Core.ImpactMaterialUnsized` values, see: ClatterObject.DynamicFriction.
        /// </summary>
        [Range(0, 1)]
        public float dynamicFriction = 0.1f;
        /// <summary>
        /// If physicMaterialMode == PhysicMaterialMode.manual, this is the physic material static friction value (0 to 1). To derive friction values from `Clatter.Core.ImpactMaterialUnsized` values, see: ClatterObject.StaticFriction.
        /// </summary>
        [Range(0, 1)]
        public float staticFriction = 0.1f;
        /// <summary>
        /// If physicMaterialMode == PhysicMaterialMode.manual or physicMaterialMode == PhysicMaterialMode.auto, this is the physic material bounciness value (0 to 1). This always needs to be set on a per-object basis, as opposed to being derived from a `Clatter.Core.ImpactMaterialUnsized` value.
        /// </summary>
        [Range(0, 1)]
        ...
        /// <summary>
        /// If massMode == MassMode.volume, hollowness is the portion of the object that is hollow (0 to 1) as follows: mass = volume * density * (1 - hollowness) where volume is the sum of the bounding box sizes of each Renderer object and density is derived from the impact material (see: `Clatter.Core.ImpactMaterialData`).
        /// </summary>
        [Range(0, 1)]
